...
class getid3_writetags {
	...
	public function FormatDataForID3v1() {
		...
		$tag_data_id3v1['track_number'] = intval( getid3_lib::iconv_fallback( $this->tag_encoding, 'ISO-8859-1', implode( ' ', ( isset( $this->tag_data['TRACK_NUMBER'] ) ? $this->tag_data['TRACK_NUMBER'] : [] ) ) ) );
	...
	public function FormatDataForID3v2( $id3v2_majorversion ) {
		...
		$ID3v2_text_encoding_lookup    = [];
		$ID3v2_text_encoding_lookup[2] = [
			'ISO-8859-1' => 0,
			'UTF-16'     => 1,
		];
		$ID3v2_text_encoding_lookup[3] = [
			'ISO-8859-1' => 0,
			'UTF-16'     => 1,
		];
